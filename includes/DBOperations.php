<?php 
    ...
    class DbOperations{
        ...
        //INSERT INTO `enquiry`(`eid`, `userid`, `ownerid`, `user_name`, `user_email`, `user_phone`, `owner_name`, `hostel_name`, `hostel_address`, `enquiry_status`, `enquiry_message`, `enquiry_date`, `enquiry_status_update_date`) VALUES
        public function insertEnquiry($userid, $ownerid, $username, $user_email, $user_phone, $hostel_name, $hostel_address, $enquiry_message){
            $sql = $this->con->prepare("INSERT INTO enquiry (userid, ownerid, user_name, user_email, user_phone, owner_name, hostel_name, hostel_address, enquiry_message) VALUES (?,?,?,?,?,?,?,?,?)");
            $sql->bind_param("iissssss",$userid, $ownerid, $username, $user_email, $user_phone, $hostel_name, $hostel_address, $enquiry_message);
            if($sql->execute()){
                return USER_CREATED;
            }else{
                return USER_FAILURE;
    ...
    public function requestHostelOwner($hostel_name,$hostel_location,$hos_lati,$hos_longi,$hostel_type,$owner_name,$contact_number,$hostel_email){
       ...
       //$sql="INSERT INTO hostel_request (hostel_name,hostel_location,loc_lattitude,loc_longitude,hostel_type,hostel_owner_name,contact_number,hostel_email) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        public function getHostelDetailsByHostelCode($hostel_code){
            ...
            else  { $user["message"]="Hostel and hostel Info both does not exists"; return $user;
            }
        }
    }
