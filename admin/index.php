          ...
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800">
                <?php
                $db = new DBOperations;
                $count = $db->getCountOfAllEnquiry();
                if ($count <= 0) {
                  $count = 0;
                }

                echo "<h5>Total Enquiry: </h5><a class='text-decoration-none' href = 'register.php'><h2>" . $count . "</h2></a>";
                ?>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Reviewed Enquiry</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">
                <?php
                $db = new DbOperations;
                echo "<h5>Total Reviewed: " . $db->getCountOfReviewedEnquiry() . "</h5>";
                ?>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Pending Enquiry</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">
                <?php
                $db = new DBOperations;
                $count = $db->getCountOfPendingEnquiry();
                if ($count <= 0) {
                  $count = 0;
                }

                echo " <h6>Pending Requests:</h6><a class='text-decoration-none text-danger' href = 'enquiry.php'><h2>" . $count . "</h2></a>";
                ?>
